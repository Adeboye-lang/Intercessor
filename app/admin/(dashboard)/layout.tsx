  ...
  return (
    <div className="flex h-screen bg-[#FAF9F6] bg-sacred-grid overflow-hidden selection:bg-[#3D532D] selection:text-[#FAF9F6] font-sans">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative">
        {/* Archival Top Header */}
        <header className="h-20 flex items-center justify-end px-10 bg-[#FAF9F6] border-b-[4px] border-[#C5A059] z-10 shrink-0 shadow-[0_10px_30px_-10px_rgba(61,83,45,0.05)] relative">
